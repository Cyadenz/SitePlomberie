    ...
    <header>
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('<?php echo e(asset('img/image1.jpg')); ?>')">
...
<!--               <h3>First Slide</h3>
          ...
          <div class="carousel-item" style="background-image: url('<?php echo e(asset('img/image2.jpg')); ?>')">
            <div class="carousel-caption d-none d-md-block">
<!--               <h3>Second Slide</h3>
          ...
          <div class="carousel-item" style="background-image: url('<?php echo e(asset('img/image3.jpg')); ?>')">
            <div class="carousel-caption d-none d-md-block">
<!--               <h3>Third Slide</h3>
